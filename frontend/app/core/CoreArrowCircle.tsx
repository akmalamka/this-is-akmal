...
export default function CoreArrowCircle({ className, onClick }: CompProps & React.HTMLProps<HTMLDivElement>) {
  return (
    <div className={classNames('w-[52px] h-[52px]', className)} onClick={onClick}>
